    ...
    <div className={style.card}>
      ...
      <div className={style.cardInfo}>
        ...
        <div className={style.textBody}>
          <span>{props.rating}</span> <AiFillStar style={{color: "#FEAA09"}}/>
        </div>
      </div>
      <div className={style.cardFooter}>
        ...
        <div className={style.cardButton}>
          <AiOutlineShoppingCart className={style.svgIcon} onClick={() => navigate(`/detail/gym/${props.id}`)}/>
          {/* <svg
            className={style.svgIcon}
            viewBox="0 0 20 20"
            onClick={() => navigate(`/detail/gym/${props.id}`)}
          >
