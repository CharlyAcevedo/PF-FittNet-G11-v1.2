          ...
          <ScrollPage page={0}>
            <Animator animation={Scrll}>
              <div className={styles.containerUser}>
                ...
                <p>
                  Aqui puedes completar los datos de tu información personal,
                  esta información es muy importante para nosotros
                  <br />
                  tanto como lo es para tí, es por eso que la tratarémos con la
                  mayor confidencialidad y discreción,
                  <br />
              ...
              <div className={styles.containerDiseases}>
                ...
                <div className={styles.boxContainerDes}>
                  <div className={styles.boxDiseases}>
                    ...
                    <textarea
                      className={
                        error.trainlimits ? styles.inputError : styles.input
                      }
                      type="text"
                      ...
                      deseaseAttribute.map((e) => {
                        return (
                          input.desease.includes(e.deseaseName) && (
                            <div
                              key={e._id}
                              className={styles.deseaseBeneficts}
                            >
                              <p
                                style={{
